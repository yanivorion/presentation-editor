...
export const O = {
  ...
  template: [
    ...
    { v:'profileMagazine',     l:'Profile Magazine' },
    { v:'profileCentered',     l:'Profile Centered' },
    { v:'profileCards',        l:'Profile Cards Row' },
    { v:'profileBoldSplit',    l:'Profile Bold Split' },
    { v:'profileDossier',      l:'Profile Dossier' },
    { v:'profileMinimal',      l:'Profile Minimal' },
    ...
    { v:'teamInitiatives',      l:'Team Initiatives Table' },
    { v:'stickyMobileCover',    l:'Sticky Mobile Cover (red)' },
    { v:'spectrumProfile',      l:'Spectrum Profile (quote + grid)' },
    { v:'spectrumLevel',        l:'Spectrum Level (3+4 grid)' },
    { v:'clusterExamples',      l:'Cluster Examples (stacked cards)' },
    { v:'spectrumLevelList',    l:'Spectrum Level List' },
  ],
  panelKind: [
    { v:'none',     l:'None' },
